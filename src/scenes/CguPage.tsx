export default function CguPage() {
    return (
        <main className={"flex flex-col items-start justify-center px-6"}>
            ...
            <div className={"pb-8"}>
                <h2 className={"text-xl font-bold pb-4"}>ARTICLE 3 : Collecte des données</h2>
                <p>
            ...
            <div className={"pb-8"}>
                ...
                <p>
                    ...
                    procédé que ce soit, sans l’autorisation expresse de l’exploitant du site
            ...
            <div className={"pb-8"}>
                <h2 className={"text-xl font-bold pb-4"}>ARTICLE 7 : Cookies</h2>
                <p>
                    ...
                    certaines fonctionnalités ou pages risquent de lui être refusées.<br />
